...
static void
code_constant(BobCompiler *c, int fcn, PVAL *);

static int
load_argument(BobCompiler *c, char *name);

static void
code_argument(BobCompiler *c, int fcn, PVAL *);

static void
code_property(BobCompiler *c, int fcn, PVAL *);

static void
code_variable(BobCompiler *c, int fcn, PVAL *);

static void
code_index(BobCompiler *c, int fcn, PVAL *);
...
{ F_ENTER;
    ...
    addbreak(c, &bentry, end);
    // addcontinue(c, &centry, nxt);
    // make sure the continue executes the third expr

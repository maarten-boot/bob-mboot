...
BobDispatch BobEnvironmentDispatch = {
        "Environment", &BobEnvironmentDispatch, BobDefaultGetProperty, BobDefaultSetProperty, BobDefaultNewInstance,
        BobDefaultPrint, BobBasicVectorSizeHandler, BobDefaultCopy, BobBasicVectorScanHandler, BobDefaultHash
};
...
BobDispatch BobStackEnvironmentDispatch = {
        "StackEnvironment", &BobEnvironmentDispatch, BobDefaultGetProperty, BobDefaultSetProperty,
        BobDefaultNewInstance, BobDefaultPrint, BobBasicVectorSizeHandler, StackEnvironmentCopy,
        BobBasicVectorScanHandler, BobDefaultHash
};
...
BobDispatch BobMovedEnvironmentDispatch = {
        "MovedEnvironment", &BobEnvironmentDispatch, BobDefaultGetProperty, BobDefaultSetProperty,
        BobDefaultNewInstance, BobDefaultPrint, BobBasicVectorSizeHandler, MovedEnvironmentCopy,
        BobBasicVectorScanHandler, BobDefaultHash
};

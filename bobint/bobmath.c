...
/* prototypes */
static BobValue
BIF_abs(BobInterpreter *c);

static BobValue
BIF_sin(BobInterpreter *c);

static BobValue
BIF_cos(BobInterpreter *c);

static BobValue
BIF_tan(BobInterpreter *c);

static BobValue
BIF_asin(BobInterpreter *c);

static BobValue
BIF_acos(BobInterpreter *c);

static BobValue
BIF_atan(BobInterpreter *c);

static BobValue
BIF_sqrt(BobInterpreter *c);

static BobValue
BIF_ceil(BobInterpreter *c);

static BobValue
BIF_floor(BobInterpreter *c);

static BobValue
BIF_exp(BobInterpreter *c);

static BobValue
BIF_log(BobInterpreter *c);

static BobValue
BIF_log2(BobInterpreter *c);

static BobValue
BIF_log10(BobInterpreter *c);

static BobValue
BIF_pow(BobInterpreter *c);
...
BIF_atan(BobInterpreter *c)
{
    ...
    case 4:
        ...
        val = BobMakeFloat(
                c, (BobFloatType) atan2(
                        FloatValue(BobGetArg(c, 3)), FloatValue(BobGetArg(c, 4))));
        break;
    default:

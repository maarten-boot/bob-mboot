...
/* property handlers */
static BobValue
BIF_printName(BobInterpreter *c, BobValue obj);
...
static int
GetSymbolProperty(BobInterpreter *c, BobValue obj, BobValue tag, BobValue *pValue);

static int
SetSymbolProperty(BobInterpreter *c, BobValue obj, BobValue tag, BobValue value);

static int
SymbolPrint(BobInterpreter *c, BobValue val, BobStream *s);

static long
SymbolSize(BobValue obj);

static void
SymbolScan(BobInterpreter *c, BobValue obj);

static BobIntegerType
SymbolHash(BobValue obj);

static BobValue
MakeSymbol(BobInterpreter *c, unsigned char *printName, int length, BobIntegerType hashValue);

...
/* file methods */
static BobCMethod methods[] = {BobMethodEntry("initialize", BIF_initialize), BobMethodEntry("Close", BIF_Close),
                               BobMethodEntry("Print", BIF_Print), BobMethodEntry("Display", BIF_Display),
                               BobMethodEntry("GetC", BIF_GetC), BobMethodEntry("PutC", BIF_PutC),
                               BobMethodEntry(0, 0)};

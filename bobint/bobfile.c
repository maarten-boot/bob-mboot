...
static BobValue
BIF_Close(BobInterpreter *c);

static BobValue
BIF_Print(BobInterpreter *c);

static BobValue
BIF_Display(BobInterpreter *c);

static BobValue
BIF_GetC(BobInterpreter *c);

static BobValue
BIF_PutC(BobInterpreter *c);
...
/* prototypes */
static void
EnterPort(BobInterpreter *c, char *name, BobStream **pStream);

static void
DestroyFile(BobInterpreter *c, BobValue obj);

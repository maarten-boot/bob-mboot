...
BobDispatch BobMethodDispatch = {
        "Method", &BobMethodDispatch, GetMethodProperty, SetMethodProperty, BobDefaultNewInstance, MethodPrint,
        MethodSize, BobDefaultCopy, MethodScan, BobDefaultHash
};
...
static int MethodPrint(BobInterpreter *c, BobValue val, BobStream *s) {
    ...
    return BobStreamPutS("<Method-", s) == 0 && BobStreamPutS(BobStringAddress(name), s) == 0 &&
           BobStreamPutC('>', s) == '>';
}
...
BobDispatch BobCMethodDispatch = {
        "CMethod", &BobMethodDispatch, GetMethodProperty, SetMethodProperty, BobDefaultNewInstance, CMethodPrint,
        CMethodSize, CMethodCopy, BobDefaultScan, BobDefaultHash
};

/* CMethodPrint - CMethod print handler */
static int CMethodPrint(BobInterpreter *c, BobValue val, BobStream *s) {
    return BobStreamPutS("<CMethod-", s) == 0 && BobStreamPutS(BobCMethodName(val), s) == 0 &&
           BobStreamPutC('>', s) == '>';
}
...
BobDispatch BobCompiledCodeDispatch = {
        "CompiledCode", &BobCompiledCodeDispatch, BobDefaultGetProperty, BobDefaultSetProperty, BobDefaultNewInstance,
        CompiledCodePrint, BobBasicVectorSizeHandler, BobDefaultCopy, BobBasicVectorScanHandler, BobDefaultHash
};
...
static int CompiledCodePrint(BobInterpreter *c, BobValue val, BobStream *s) {
    ...
    return BobStreamPutS("<CompiledCode-", s) == 0 && BobStreamPutS(BobStringAddress(name), s) == 0 &&
           BobStreamPutC('>', s) == '>';
}

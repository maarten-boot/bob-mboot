...
/* Method handlers */
static int
GetMethodProperty(BobInterpreter *c, BobValue obj, BobValue tag, BobValue *pValue);

static int
SetMethodProperty(BobInterpreter *c, BobValue obj, BobValue tag, BobValue value);

static int
MethodPrint(BobInterpreter *c, BobValue val, BobStream *s);

static long
MethodSize(BobValue obj);

static void
MethodScan(BobInterpreter *c, BobValue obj);
...
/* CMethod handlers */
static int
CMethodPrint(BobInterpreter *c, BobValue val, BobStream *s);

static long
CMethodSize(BobValue obj);

static BobValue
CMethodCopy(BobInterpreter *c, BobValue obj);
...
static int
CompiledCodePrint(BobInterpreter *c, BobValue val, BobStream *s);

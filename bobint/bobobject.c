...
BobDispatch BobObjectDispatch = {
        "Object", &BobObjectDispatch, GetObjectProperty, SetObjectProperty, BobMakeObject, BobDefaultPrint, ObjectSize,
        BobDefaultCopy, ObjectScan, BobDefaultHash
};
...
BobDispatch BobPropertyDispatch = {
        "Property", &BobPropertyDispatch, BobDefaultGetProperty, BobDefaultSetProperty, BobDefaultNewInstance,
        BobDefaultPrint, PropertySize, BobDefaultCopy, PropertyScan, BobDefaultHash
};

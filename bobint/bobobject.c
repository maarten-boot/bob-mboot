...
static int
SetObjectProperty(BobInterpreter *c, BobValue obj, BobValue tag, BobValue value);

static void
ObjectScan(BobInterpreter *c, BobValue obj);

static long
ObjectSize(BobValue obj);

static BobValue
CopyPropertyTable(BobInterpreter *c, BobValue table);

static BobValue
CopyPropertyList(BobInterpreter *c, BobValue plist);

static void
CreateHashTable(BobInterpreter *c, BobValue obj, BobValue p);

static int
ExpandHashTable(BobInterpreter *c, BobValue obj, BobIntegerType i);
...
static int
ExpandHashTable(BobInterpreter *c, BobValue obj, BobIntegerType hashValue)
{

...
static int
GetIntegerProperty(BobInterpreter *c, BobValue obj, BobValue tag, BobValue *pValue);

static int
SetIntegerProperty(BobInterpreter *c, BobValue obj, BobValue tag, BobValue value);

static int
IntegerPrint(BobInterpreter *c, BobValue obj, BobStream *s);

static long
IntegerSize(BobValue obj);

static BobValue
IntegerCopy(BobInterpreter *c, BobValue obj);

static BobIntegerType
IntegerHash(BobValue obj);

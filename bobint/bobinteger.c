...
#endif
        BobMethodEntry("toInteger", BIF_toInteger), BobMethodEntry("toString", BIF_toString), BobMethodEntry(0, 0)};
...
BobDispatch BobIntegerDispatch = {
        "Integer", &BobIntegerDispatch, GetIntegerProperty, SetIntegerProperty, BobDefaultNewInstance, IntegerPrint,
        IntegerSize, IntegerCopy, BobDefaultScan, IntegerHash
};

...
/* prototypes */
static int
DisplayVectorValue(BobInterpreter *c, BobValue val, BobStream *s);

static int
DisplayStringValue(BobValue val, BobStream *s);
...
static int
CloseNullStream(BobStream *s);

static int
NullStreamGetC(BobStream *s);

static int
NullStreamPutC(int ch, BobStream *s);
...
static int
CloseStringStream(BobStream *s);

static int
StringStreamGetC(BobStream *s);

static int
StringStreamPutC(int ch, BobStream *s);
...
static int
CloseStringOutputStream(BobStream *s);

static int
StringOutputStreamGetC(BobStream *s);

static int
StringOutputStreamPutC(int ch, BobStream *s);
...
static int
CloseIndirectStream(BobStream *s);

static int
IndirectStreamGetC(BobStream *s);

static int
IndirectStreamPutC(int ch, BobStream *s);
...
static int
CloseFileStream(BobStream *s);

static int
FileStreamGetC(BobStream *s);

static int
FileStreamPutC(int ch, BobStream *s);

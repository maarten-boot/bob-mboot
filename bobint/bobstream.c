...
static BobStreamDispatch nullDispatch = {
        CloseNullStream, NullStreamGetC, NullStreamPutC
};
...
static BobStreamDispatch stringDispatch = {
        CloseStringStream, StringStreamGetC, StringStreamPutC
};
...
static BobStreamDispatch stringOutputDispatch = {
        CloseStringOutputStream, StringOutputStreamGetC, StringOutputStreamPutC
};
...
BobStreamDispatch indirectDispatch = {
        CloseIndirectStream, IndirectStreamGetC, IndirectStreamPutC
};
...
BobStreamDispatch fileDispatch = {
        CloseFileStream, FileStreamGetC, FileStreamPutC
};

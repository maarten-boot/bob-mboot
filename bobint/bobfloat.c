...
static int
GetFloatProperty(BobInterpreter *c, BobValue obj, BobValue tag, BobValue *pValue);

static int
SetFloatProperty(BobInterpreter *c, BobValue obj, BobValue tag, BobValue value);

static int
FloatPrint(BobInterpreter *c, BobValue obj, BobStream *s);

static long
FloatSize(BobValue obj);
